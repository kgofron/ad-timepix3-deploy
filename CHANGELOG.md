...
- Sync MediPix3 Expert with driver `medipix3-integration`: taller `MediPix3.bob` for Tools **Img** / **HDF**; docs for Pva7/Pva8 + HDFImg; `site.env.example` notes alternate `ADTIMEPix3_HOME` (e.g. support2); re-run `05-install-phoebus.sh` to pick up `Mpx3HdfImgConfig` / `Mpx3ImgMonitor`
