...
| `common/subscreens/_ad_view_image_pva_profiles.bob` | NDStats cursor profiles; axes `$(ProfileStats)Cal:*.AVAL` ([ADCore #600](https://github.com/areaDetector/ADCore/pull/600)) |
| `common/subscreens/_ad_view_*.bob` | Image / other bob widgets |
