...
| ADCore: `No rule to make target ... libpvData.a` | EPICS 7 PVA missing or not found — verify `ls $EPICS_BASE/lib/linux-x86_64/libpvData.a`; rebuild step 01 if absent; re-run `configure-areadetector.sh` and step 03 |
